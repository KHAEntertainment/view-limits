...
// All declared reason codes from every module, for the completeness test.
const ALL_DECLARED_REASONS = Object.freeze([
  // score-candidates.js REASON_ORDER
  ...REASON_ORDER,
  // jev-client.js JEV_REASONS
  'jev-model-unconfigured', 'jev-endpoint-unconfigured', 'jev-transport-absent',
  'jev-catalog-transport-absent', 'jev-timeout', 'jev-unreachable', 'jev-http-error',
  'jev-catalog-unreachable', 'jev-catalog-timeout', 'jev-catalog-malformed',
  'jev-model-not-in-catalog', 'jev-structured-output-unverified', 'jev-response-malformed',
  'jev-response-schema-invalid', 'jev-low-confidence',
  // task-profile.js reason codes
  'task-profile-field-absent', 'task-profile-value-invalid',
  'response-not-object', 'confidence-invalid', 'profile-not-object',
  // recommend.js pipeline codes
  'jev-readiness-gate-closed', 'jev-model-unverified', 'jev-verification-not-attempted',
  'profile-dimension-unresolved', 'jev-suggestion-unknown-candidate', 'jev-suggestion-ineligible',
  'candidate-id-duplicate',
  // score-candidates.js additional fallback codes
  'cached-state-absent', 'caller-fact-absent', 'candidate-fact-absent',
  // frozen-module fact-reason codes
  ...
  'model-evidence-absent', 'model-comparison-unavailable',
]);
